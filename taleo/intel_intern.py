...
def intel_parse_javascript(browser, page) :
	sleep(1.5)
	records = []
	...
	update_spreadsheet(records, 'Intel_Intern', page)
...
if __name__ == '__main__':
	...
	browser.get(url)
	checkbox_1 = WebDriverWait(browser, 5).until(EC.presence_of_element_located((By.XPATH, '//*[@id="JOB_TYPE-content"]/div[1]/a/label/span/span[1]')))
	checkbox_1.click()
	sleep(1)
	checkbox_2 = WebDriverWait(browser, 5).until(EC.presence_of_element_located((By.XPATH, '//*[@id="JOB_TYPE-content"]/div[3]/a/label/span/span[1]')))
	checkbox_2.click()
	sleep(1)
	checkbox_3 = WebDriverWait(browser, 5).until(EC.presence_of_element_located((By.XPATH, '//*[@id="JOB_TYPE-content"]/div[5]/a/label/span/span[1]')))
	checkbox_3.click()
	...
	# 		button.click()	
	# intel_parse_javascript(browser, 17)
	...
	for i in range(40, 54) :
		if i != 1 :
			...
			button = pager.find_elements_by_tag_name("span")[3].find_element_by_tag_name("span").find_element_by_tag_name("a")
			button.click()
		intel_parse_javascript(browser, i)
